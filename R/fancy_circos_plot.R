...
#' Provide the sample ID of interest in with the `this_sample_id` parameter. This function calls [GAMBLR.utils::assign_cn_to_ssm] and [GAMBLR.results::get_combined_sv] to retrieve data for plotting.
...
#' @param gene_list Optional parameter to annotate genes on the circos plot from a data frame of genes. Is compatible with [GAMBLR.utils::gene_to_region] (return_as = "bed") output format. See examples.
